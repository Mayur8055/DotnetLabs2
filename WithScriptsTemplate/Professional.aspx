...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p><strong>Add New Employee</strong></p>
        ...
        <p>
            ...
            <asp:RangeValidator ID="Rangevalidator1" runat="server" ErrorMessage="Invalid range" MaximumValue="99999999" MinimumValue="300000" SetFocusOnError="True" ControlToValidate="txtSalary"></asp:RangeValidator>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtSalary"></asp:RequiredFieldValidator>
        </p>
        <p>
